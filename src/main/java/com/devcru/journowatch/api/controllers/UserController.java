...
@CrossOrigin(origins = "http://journowatchwebclient-sjw.rhcloud.com/admin/portal#/user", methods={RequestMethod.PUT, RequestMethod.DELETE}) // use https:// when appropriate
